...
namespace MechHisui.Superfight.Collections
{
    internal delegate Task NotifyCollectionChangedAsync(object sender, NotifyCollectionChangedEventArgs e);
    //internal delegate Task NotifyPropertyChangedAsync(object sender, PropertyChangedEventArgs e);

    internal sealed class AsyncObservableCollection<T> : ObservableCollection<T>
    {
        /// <summary>
        /// Initializes a new instance of AsyncObservableCollection that is empty and has default initial capacity.
        /// </summary>
        ...
        //private event NotifyPropertyChangedAsync PropertyChangedAsync;
        ...
        protected override void ClearItems()
        {
            ...
            //await PropertyChangedAsync?.Invoke(
        }
